...
export default function EpisodeModal({ group, loading, onClose }) {
        ...
        {loading ? (
          ...
          <div className="episode-modal__list">
            ...
            {activeSeason.episodes.map((ep, i) => (
              <div key={ep.id || i} className="episode-card" onClick={() => openPlayer(ep)}>
                ...
                <button className="episode-card__play" onClick={(e) => { e.stopPropagation(); openPlayer(ep); }}>
